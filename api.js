...
const API = {
    ...
    async getDeployment(deploymentId, locationName) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}`);
    },
    ...
    async addConnection(deploymentId, locationName, connectionData) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}/connections`, {
            method: 'POST',
    ...
    async deleteConnection(deploymentId, locationName, connectionId) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}/connections/${connectionId}`, {
            method: 'DELETE',
        });
    },

    async validateConnections(deploymentId, locationName) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}/validate`);
    },

    // Statistics and Analysis
    async getStatistics(deploymentId, locationName) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}/statistics`);
    },

    async getUnusedItems(deploymentId, locationName) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}/unused-items`);
    },

    async getConnectionGraph(deploymentId, locationName) {
        return this.request(`/deployments/${deploymentId}/locations/${locationName}/graph`);
    },
};