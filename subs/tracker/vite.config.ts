...
// works without duplicating creds into subs/tracker/.
const repoRoot = resolve(dirname(fileURLToPath(import.meta.url)), '../..');

// Per-sub Vite config for the tracker React app (#340).
...
// builds a self-contained bundle to ./dist for the deploy-tracker.yml GHA caller
