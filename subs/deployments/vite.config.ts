...
// works without duplicating creds into subs/deployments/.
const repoRoot = resolve(dirname(fileURLToPath(import.meta.url)), '../..');

// Per-sub Vite config for the deployments React app (#338).
...
// builds a self-contained bundle to ./dist for the GitHub Actions deploy
