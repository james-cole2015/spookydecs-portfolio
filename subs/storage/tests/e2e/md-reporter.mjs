/**
 * Minimal markdown reporter for the storage Playwright suite (#589) — copied from
 * subs/deployments/tests/e2e/md-reporter.mjs (#554), zero dependencies. Writes a
...
export default class MarkdownReporter {
  ...
  onEnd(result) {
    ...
    lines.push('# Storage E2E — Run Report');
    lines.push('');
